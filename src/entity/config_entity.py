...
class DataTransformationConfig:
    ...
    all_columns_path : str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
                                                   ALL_COLUMN_NAME.replace("csv", "npy"))
@dataclass
...
@dataclass
class CreditCardDefaultPredictorConfig:
